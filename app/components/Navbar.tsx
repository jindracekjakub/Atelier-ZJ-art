...
export default function Navbar() {
    ...
    return (
        <nav className="bg-gradient-to-r from-[#4b3621] via-[#3e2b1f] to-[#2b1d12] text-[#f5ecd9] font-serif sticky top-0 z-50 shadow-lg overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 md:px-8 h-15 md:h-18">
                <div className="flex justify-center items-center ">

                    <div className="hidden md:flex space-x-5 bg-[#1a1009]/20 rounded-[16px] p-2 mt-3">
                        {menuItems.map((item) => (
                            <Link
                                key={item.href}
                                href={item.href}
                                className="hover:text-[#f0d9b5] px-3 py-1 rounded-[12px] transition-all duration-200 hover:bg-[#2b1d12]/40"
                            >
                                {item.label}
                            </Link>
                        ))}
                ...
                <div className="flex justify-end items-center">
                    ...
                    <div className="md:hidden">
                        <button
                            ...
                            className="w-12 h-12 flex items-center justify-center rounded-[12px] bg-[#2b1d12]/30 hover:bg-[#2b1d12]/50 transition-all duration-200 mt-1"
                        >
